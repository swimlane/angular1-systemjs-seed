...
// code from http://christopherthielen.github.io/ui-router-extras/#/future
// slightly modified and size reduced
export var futureStateModule = angular.module('ct.ui.router.extras',[]);

futureStateModule.provider('$futureState',
...
futureStateModule.run(['$futureState',
